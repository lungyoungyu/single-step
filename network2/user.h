...
class User {
 public:
 	...
 	int & getDepth();
 	void setDepth(int depthValue);
 	int & getPredecessor();
 	void setPredecessor(int predecessorValue);
 ...
 private:
 	...
 	// predecessor of user
 	int predecessor;
 	// score of user: number of common friends between who and user
 	int score;
 	// check if user has been compared before
 	bool check;
};
